...
final class Version20240318184458 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commentaire_tache (id_user INT DEFAULT NULL, id_C INT AUTO_INCREMENT NOT NULL, date_C DATE NOT NULL, texte_C VARCHAR(255) NOT NULL, id_T INT DEFAULT NULL, INDEX IDX_160BE8696B3CA4B (id_user), INDEX IDX_160BE8697991D01F (id_T), PRIMARY KEY(id_C)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE commentaire_tache ADD CONSTRAINT FK_160BE8696B3CA4B FOREIGN KEY (id_user) REFERENCES end_user (id_user)');
        $this->addSql('ALTER TABLE commentaire_tache ADD CONSTRAINT FK_160BE8697991D01F FOREIGN KEY (id_T) REFERENCES tache (id_T) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire_tache DROP FOREIGN KEY FK_160BE8696B3CA4B');
        $this->addSql('ALTER TABLE commentaire_tache DROP FOREIGN KEY FK_160BE8697991D01F');
        ...
        $this->addSql('DROP TABLE commentaire_tache');

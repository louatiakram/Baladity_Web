...
class ChatbotController extends AbstractController
{
    ...
    private function guessResponse(string $input): string
    {
        ...
        $keywordResponses = [
            ...
            "tomorrow ghodwa" => "Tomorrow's date is " . date("Y-m-d", strtotime("+1 day")),
            ...
            "what do you like to do chno t7ib taamel" => "I enjoy helping users and learning new things!",
            "who are you chknk tqui toi" => "I'm a Baladity chatbot designed by Akram, to assist you with tasks and provide information.",
            "can you help me kifeh nijim n3awnek" => "Of course, I'm here to help. What do you need assistance with?",
            "what can you do chno tijim taamel" => "I can answer questions, provide information, and assist you with various tasks.",
            "tell me a joke het tayech nokta" => "Why don't scientists trust atoms? Because they make up everything!",
            "what is the meaning of life ma3na hayet" => "The meaning of life is subjective and can vary from person to person.",
            "tell me a fact het fact" => "Did you know that the shortest war in history lasted only 38 minutes?",
            ...
            "fuck you bara nayek" => "fuck you too!",
            "chbik" => "chbini",
